...
// cause the output to be the same length as the input and there is little
...
// 
// Author: Matthew Forrester <matthew.forrester_at_mediaequals.com> / <matt_at_keyboardwritescode.com>
...
function(inData,mapFunc,reduceFunc,extraData) {
    ...
    (function() { // Gets an exportFunction to normalize Node / Dojo / window.*
        ...
        if (typeof jQuery === 'function') { // jQuery Plugin
            return function(source) {
                return jQuery.fn.me_map_reduce = source;
            };
        }
    ...
    (function() { // Gets the deepCopyFunction
        if ((typeof jQuery === 'function') && (jQuery.hasOwnProperty('extend'))) {
            return function(source) {
